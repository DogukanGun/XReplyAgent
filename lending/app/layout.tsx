...
export const metadata: Metadata = {
  title: "X Reply Agent - Hyperliquid Community",
  description: "AI agent that auto-replies to questions on X with Hyperliquid insights powered by GoldRush MCP",
};
              ...
              <div className="flex items-center">
                <Link href="/" className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center">
                    <Image src="/globe.svg" alt="Logo" width={20} height={20} className="invert" />
                  </div>
                  <span className="text-lg font-semibold">X Reply Agent</span>
                </Link>
              </div>
        ...
        <footer className="bg-gray-100 dark:bg-gray-800 mt-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center text-gray-600 dark:text-gray-400">
              <p>© {new Date().getFullYear()} X Reply Agent. Built for Hyperliquid Community Hackathon.</p>
            </div>
          </div>
        </footer>
      </body>
